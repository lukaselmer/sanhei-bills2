...
describe('BillsListComponent', () => {
  ...
  describe('bahaviour', () => {
    ...
    it('should render the row for the bill', fakeAsync(() => {
      ...
      expect(queryContent('mat-card-subtitle :first-child')).toEqual(`${billView.title}, ${billView.descriptionTitle}`);
      ...
      expect(queryContent('mat-card-content :nth-child(3)')).toEqual(`CHF750.00 netto | CHF733.65 brutto`);

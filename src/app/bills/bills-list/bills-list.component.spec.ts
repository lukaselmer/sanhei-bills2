...
describe('BillsListComponent', () => {
  ...
  describe('construction', () => {
    it(
      'reads the params from the activated route',
      fakeAsync(() => {
  ...
  describe('bahaviour', () => {
    ...
    it(
      'should render a row for each bill',
      fakeAsync(() => {
        fixture.detectChanges();
    ...
    it(
      'should render the row for the bill',
      fakeAsync(() => {
        fixture.detectChanges();
        const compiled = fixture.debugElement.nativeElement;
    ...
    it(
      'should search through the bills',
      fakeAsync(() => {
        const router: Router = TestBed.get(Router);
        fixture.detectChanges();
        expect((component as any).searchTermStream.getValue()).toEqual({

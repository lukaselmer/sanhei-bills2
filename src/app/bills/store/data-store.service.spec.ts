...
describe('DataStoreService', () => {
  ...
  describe('loadData', () => {
    it(
      'should load data from firebase if there is no cache',
      waitForAsync(() => {
        const db = {
          bills: {
            1: {
    ...
    it(
      'should not store deleted entries if there is no cache',
      waitForAsync(() => {
        const db = {
          bills: {
            1: { id: 1, name: 'B1' },
    ...
    it(
      'should not load partial data from firebase if there is a cache',
      waitForAsync(() => {
    ...
    it(
      'should delete entries marked as deleted',
      waitForAsync(() => {
        spyOn(idbMock, 'loadFromIDB').and.returnValues(
          Promise.resolve({
            1: {
